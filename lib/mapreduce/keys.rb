module MapRedus
  ...
  #
  redis_key :processes, "mapreduce:processes"
  redis_key :processes_count, "mapreduce:processes:count"  ## TODO: use this
  
  # Holds the information (mapper, reducer, etc.) in json format for a map reduce process with pid PID
  #
  redis_key :pid, "mapreduce:process:PID"

  # All the keys that the map produced
  #
  redis_key :keys, "mapreduce:process:PID:keys"

  # The hashed key to actual string value of key
  #
  redis_key :hash_to_key, "mapreduce:process:PID:keys:HASHED_KEY" # to ACTUAL KEY
  ...
  # key - list of values
  #
  redis_key :map, "mapreduce:process:PID:map_key:HASHED_KEY"
  redis_key :reduce, "mapreduce:process:PID:map_key:HASHED_KEY:reduce"
  
  # Temporary redis space for reduce functions to use
  #
  redis_key :temp, "mapreduce:process:PID:temp_reduce_key:HASHED_KEY:UNIQUE_REDUCE_HOSTNAME:UNIQUE_REDUCE_PROCESS_ID"
  ...
  #
  redis_key :result, "mapreduce:process:PID:result"
  ...
  #       of processes
  #
  redis_key :slaves, "mapreduce:process:PID:master:slaves"
  ...
  #            not_started
  #
  # contained in the ProcessInfo hash (redis_key :state, "mapreduce:process:PID:master:state")
  #
  ...
  #
  redis_key :requested_at, "mapreduce:process:PID:request_at"
  redis_key :started_at, "mapreduce:process:PID:started_at"
  redis_key :finished_at, "mapreduce:process:PID:finished_at"
  redis_key :recent_time_to_complete, "mapreduce:process:recent_time_to_complete"
end
